    ...
    st.markdown(
        ...
        <div style="padding: 48px 0 40px 0; border-bottom: 1px solid #d1d9e6; margin-bottom: 48px;">
            ...
            <div style="font-size:13px; color:#6b7280; font-family:monospace; margin-top:8px; line-height:1.6;">
                ...
                <a href="https://waymo.com/open/" style="color:#3b82f6; text-decoration:none;"
                   onmouseover="this.style.textDecoration='underline'"
                   onmouseout="this.style.textDecoration='none'">Motion Dataset v1.3.1</a>
                &nbsp;·&nbsp;
                <a href="https://github.com/rafaelmaranon/waymo-validation-lab"
                   style="color:#3b82f6; text-decoration:none; display:inline-flex; align-items:center; gap:4px; vertical-align:middle;"
                   onmouseover="this.style.textDecoration='underline'"
                   onmouseout="this.style.textDecoration='none'">
                    <svg height="14" width="14" viewBox="0 0 16 16" fill="#3b82f6" style="vertical-align:middle;">
